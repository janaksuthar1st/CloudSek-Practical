...
-keep class com.cloudsek.practicaljanak.models.** {*;}
-keep class com.cloudsek.practicaljanak.common.** {*;}
...
-keepclassmembers class com.cloudsek.practicaljanak.** { public <init>(...); }
